    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5">
                        <h2 style="color:red;">User <b>Management</b></h2>
...
<div id="section2">
<b>details</b>
<p class="one"    >JavaScript is the world's most popular programming language.

JavaScript is the programming language of the Web.

JavaScript is easy to learn.

This tutorial will teach you JavaScript from basic to advanced.JavaScript is the world's most popular programming language.
...
<i class="two"    >JavaScript is the world's most popular programming language.
...
This tutorial will teach you JavaScript from basic to advanced.</d>
</div>
</body>
</html>